...
describe('Examples', () => {
  ...
  it('Transform response to uppercase (streaming)', (done) => {
    const cors_anywhere = createServer()
    ...
    const http_server = http.createServer((req, res) => {
      ...
      res.write = (data, encoding, callback) => {
        ...
        originalWrite.call(res, data, encoding, callback)
      }
  ...
  it('Transform response to uppercase (buffered)', (done) => {
    const cors_anywhere = createServer()
